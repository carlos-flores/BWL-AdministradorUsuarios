...
<spring:url value="/users/save" var="urlPublicSave" />
...
<body>
	...
	<div class="container">
		...
		<h3 class="blog-title">
			<span class="label label-success">Nuevo Usuario</span>
		</h3>

		<form:form class="form" action="${urlPublicSave}" method="post" modelAttribute="usuario">
			<form:hidden path="id"/>
